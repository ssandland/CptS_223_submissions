...
void cal_max() {
    ...
    /*======================================================/ 
	\ Date: 4.22.21                                         \
	/ Current State of function: Works, but not 100%        /
	\ TODO: Find out why the max is not always right        \
	/ Notes: Citical seems to work better for updating max  /
    \        and faster than single                         \
	/======================================================*/
    omp_set_num_threads(num_threads);
